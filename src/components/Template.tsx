    ...
    return (
      <>
        <div className="origin-top flex justify-center">
          <div
            ref={ref}
            className="flex overflow-hidden  text-black flex-col aspect-[8.5/11] w-[95%] lg:w-[1000px] bg-white"
          >
            ...
            <div className="flex-1 flex flex-col px-8">
              ...
              <div className="flex-1  flex gap-1 w-full py-2">
                <div className="w-[250px] flex flex-col justify-between">
                  <div>
                    <div className="p-2 font-bold bg-gray-300">EDUCATION</div>
                    {form.education.map((edu: any, i: number) => (
                      <div key={i}>
                        <p className="mt-2 text-sm font-semibold">
                          {edu.degree} - {edu.fieldStudy}
                        </p>
                  ...
                  <div>
                    <div className="mt-2 p-2 font-bold bg-gray-300">SKILLS</div>
                    {form.skills.map((skill: any, i: number) => (
                      <div
                        key={i}
                        className="grid grid-cols-2 px-2 py-1 gap-3 items-center"
                      >
                        ...
                        <div className="bg-gray-300 h-2 w-full overflow-hidden rounded-md">
                          <div
                            style={{
                              width:
                                parseInt(skill.level) === 5
                                  ? '100%'
                                  : parseInt(skill.level) === 4
                                  ? '80%'
                                  : parseInt(skill.level) === 3
                                  ? '60%'
                                  : parseInt(skill.level) === 2
                                  ? '40%'
                                  : '20%',
                            }}
                  ...
                  <div>
                    <div className="mt-2 p-2 font-bold bg-gray-300">SOCIAL</div>
                ...
                <div className="flex-1 flex flex-col">
                  <div>
                    <div className="p-2 font-bold bg-gray-400">PROFILE</div>
                    <div className="p-4">
                      <p className="text-sm">{form.summary}</p>
                    </div>
                  </div>
                  <div>
                    <div className="p-2 font-bold bg-gray-400">EXPERIENCE</div>
                    {form.experience.map((exp: any, i: number) => (
                      <div key={i} className="p-4">
                        ...
                        <p className="text-[12px]">
                          ...
                          {exp.endDate === 0 ? 'Present' : exp.endDate}
                        </p>
                        <p className="mt-2 text-sm">{exp.jobDescription}</p>
                      </div>
                    ))}
                  </div>
                </div>
